      ...
      <div className="min-h-screen grid place-items-center bg-background px-4">
        <div className="max-w-sm w-full bg-card border border-border rounded-2xl p-8 text-center">
          ...
          <div className="mt-6 flex flex-col gap-3">
            <Link
              to="/"
              className="rounded-full bg-primary text-primary-foreground py-2 font-semibold"
            >
              Go home
            </Link>
            ...
            <button
              onClick={signOut}
              className="rounded-full border border-border py-2 font-semibold"
            >
              Sign out
            </button>
          </div>
    ...
    <div className="min-h-screen grid place-items-center bg-background px-4">
      <div className="max-w-sm w-full bg-card border border-border rounded-2xl p-8 shadow-soft">
        ...
        <button
          ...
          className="mt-6 w-full rounded-full border border-border py-2.5 font-semibold hover:bg-muted transition"
        >
